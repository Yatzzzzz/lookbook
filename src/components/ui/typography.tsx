...
export function Muted({ children, className }: TypographyProps) {
  return (
    <p className={cn("text-sm dark:text-gray-300 text-gray-700", className)}>
      {children}
    </p>
  );
}
...
export function HighContrastText({ children, className }: TypographyProps) {
  return (
    <p className={cn("text-black dark:text-white", className)}>
      {children}
    </p>
  );
}
...
export function Highlight({ children, className }: TypographyProps) {
  return (
    <span className={cn("bg-primary-foreground dark:bg-primary px-1 py-0.5 rounded text-primary dark:text-primary-foreground", className)}>
      {children}
    </span>
  );
} 