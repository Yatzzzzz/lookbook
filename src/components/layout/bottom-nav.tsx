...
export function BottomNav({ className = '' }: BottomNavProps) {
  ...
  return (
    <nav className={`fixed bottom-0 left-0 right-0 z-10 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 md:hidden ${className}`}>
      <div className="flex justify-around items-center py-2">
        ...
        <Link
          href="/search"
          className={`flex flex-col items-center p-2 ${
            isActive('/search') ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'
          }`}
        >
          <Search size={24} />
