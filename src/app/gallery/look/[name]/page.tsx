...
import { Share2, Bookmark, Heart, Star, ShoppingCart, Shirt, User, ThumbsUp, Tag, ChevronLeft, ChevronRight, ImageOff } from 'lucide-react';
  ...
  const handleSave = async () => {
    try {
      ...
      if (newSavedState) {
        await supabase
          .from('saved_looks')
          .insert({ user_id: user.id, look_id: lookData.look_id });
      } else {
        await supabase
          .from('saved_looks')
          .delete()
          .match({ user_id: user.id, look_id: lookData.look_id });
      }
  ...
  const handleFollow = async () => {
    try {
      ...
      if (newFollowingState) {
        await supabase
          .from('followers')
          .insert({ follower_id: user.id, following_id: lookData.user_id });
      } else {
        await supabase
          .from('followers')
          .delete()
          .match({ follower_id: user.id, following_id: lookData.user_id });
      }
      ...
      {successMessage && (
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-green-500 text-white p-3 rounded-md shadow-lg z-50 max-w-md animate-fade-in">
          <div className="flex items-center">
            ...
            <p>{successMessage}</p>
            <button onClick={() => setSuccessMessage(null)} className="ml-auto text-white hover:text-gray-200 focus:outline-none">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                  ...
                  <div className="p-6 md:w-1/2">
                    ...
                    <div className="space-y-3">
                      ...
                      <button 
                        ...
                        className="w-full border border-gray-300 hover:bg-gray-100 py-2 px-4 rounded-md flex items-center justify-center"
                      >
                        <Heart size={16} className={cn("mr-2", wishlisted && "fill-red-500 text-red-500")} />
          ...
          <div className="md:flex flex-col md:flex-row">
            <div className="md:w-3/5">
              <div className="relative pb-[100%] overflow-hidden bg-white rounded-lg">
                {imageUrl ? (
                  <img 
                    src={imageUrl} 
                    alt="Fashion look" 
              ...
              <div className="mt-4">
                ...
                <div className="p-4 grid grid-cols-7 gap-2 border-b">
                  ...
                  <button 
                    ...
                    aria-label="Save"
                  >
                    <Bookmark size={20} className={cn("mb-1", saved && "fill-blue-500 text-blue-500")} />
                  ...
                  <button 
                    ...
                    aria-label="Follow"
                  >
                    <User size={20} className={cn("mb-1", following && "text-blue-500")} />
                  ...
                  <button 
                    ...
                    aria-label="Rate"
                  >
                    <Star size={20} className={cn("mb-1", rating > 0 && "fill-yellow-400 text-yellow-400")} />
                  ...
                  <button 
                    ...
                    aria-label="Wishlist"
                  >
                    <Heart size={20} className={cn("mb-1", wishlisted && "fill-red-500 text-red-500")} />
                ...
                <div className="p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {(!lookData?.tags || lookData.tags.length === 0) && (
                      <span className="text-gray-500 text-sm">No tags available for this look</span>
                    )}
                  </div>
                </div>
              </div>
            ...
            <div className="p-6 md:w-2/5">
              ...
              <div className="mb-6">
                ...
                {lookData?.description && (
                  <p className="text-gray-700">{lookData.description}</p>
                )}
              </div>
