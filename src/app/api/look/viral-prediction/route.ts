...
// POST /api/look/viral-prediction - Get AI prediction for viral potential
export async function POST(request: NextRequest) {
  try {
    ...
    // Just return a random score between 1-100 for now
    ...
    return NextResponse.json({
      ...
      viral_potential: viralScore > 70 ? 'high' : viralScore > 40 ? 'medium' : 'low',
      factors: [
        'Image quality',
        'Trend alignment',
        'Color palette',
    ...
    console.error('Error in viral prediction:', err);
