...
// Initialize Vertex AI (you will need to configure your project and region details)
const clientOptions = {
  project: 'lookbook-454113', // Replace with your Google Cloud Project ID
...
export async function POST(req) {
  try {
    ...
    const response = await processImageAndQuestion(image, question);
...
async function processImageAndQuestion(image, question) {
  if (!image) {
  ...
  const generationConfig = {
    ...
    temperature: 0.4, // Adjust for more or less creative responses
    topP: 1,
  };
